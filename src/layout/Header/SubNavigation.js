...
function SubNavigation() {
  ...
  return (
    <div className='absolute z-20 w-full h-[calc(100vh-100px)] top-[100px] backdrop-blur flex items-start justify-center'>
      <div className='max-w-[1220px] w-[calc(100%-80px)] max-h-[432px] h-[90%] pt-8'>
                ...
                <div className='flex flex-col h-full w-1/5'>
                  ...
                  <div>
                    <ul className='flex flex-col'>
                      {val.items.map((item) => (
                        <li className='my-3 text-xs'>{item.title}</li>
                      ))
                      }
                    </ul>
                  </div>
