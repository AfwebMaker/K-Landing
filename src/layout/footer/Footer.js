...
//images
import Namad1 from "../../assets/images/footer/Namad 1.png"
import Namad2 from "../../assets/images/footer/Namad 2.png"
import Namad3 from "../../assets/images/footer/Namad 3.png"
import Namad4 from "../../assets/images/footer/Namad 4.png"
import KargoshaLogo from "../../assets/images/Kargosha Logo.svg"
...
const Footer = () => {
    return (
        <footer className="text-center bg-color-1 flex items-center flex-col">
                    ...
                    <div className=" grid grid-cols-12 col-span-12 lg:col-span-12 lg:flex justify-between items-start text-right text-[14px] transition-all duration-300">
                        {footerContent.map((item) => (
                            <div key={item.id} className="ml-3 col-span-12 sm:col-span-6 text-center lg:text-right mb-10 transition-all duration-500 ">
                                <h5 className="uppercase font-extrabold mb-2.5 text-color-font-1">
                                    {item.title}
                                </h5>
                                ...
                                <ul className="list-none">
                                    {item.content.map((item, i) => (
                                        <li key={i} className="mb-2">
                                            <Link to="#!" className="text-color-font-2 font-normal">
                                                {item}
                                            </Link>
                                        </li>
                                    ))}
            ...
            <div className="flex flex-col md:flex-row items-center justify-between w-full text-right text-[10px] font-bold text-white px-3 md:px-10 py-3 leading-6  bg-color-2">
