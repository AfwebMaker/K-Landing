          ...
          <div className={`flex fcc ${openText ? "mb-24" : "mb-10"}`}>
            <section className={`${openText ? "overscroll-none" : "overflow-hidden"} relative w-full bg-white flex flex-col fcc lg:inline`}>
              ...
              <div className='mt-10 lg:mt-0'>
                ...
                <div className={`absolute right-0 flex items-end justify-center h-40 ${openText ? "w-full -bottom-20 px-5" : "w-full lg:w-[51%] bottom-0 pl-2 bg-gradient-to-t from-white to-transparent"}`}>
